...
import com.keelin.common.BaseDto;
import com.keelin.common.Constant;
import com.keelin.common.ResponseBean;
import com.keelin.exception.CustomException;
import com.keelin.exception.CustomUnauthorizedException;
import com.keelin.model.User;
import com.keelin.model.dto.UserDto;
import com.keelin.model.valid.UserEditValidGroup;
import com.keelin.model.valid.UserLoginValidGroup;
import com.keelin.service.IUserService;
import com.keelin.utils.AesCipherUtil;
import com.keelin.utils.JwtUtil;
import com.keelin.utils.UserUtil;
...
public class UserController {
    ...
    public ResponseBean add(@Validated(UserEditValidGroup.class) @RequestBody UserDto userDto) {
        ...
        userDtoTemp.setAccount(userDto.getAccount());
        userDtoTemp = userService.selectOne(userDtoTemp);
        if (userDtoTemp != null && !StringUtils.isEmpty(userDtoTemp.getPassword())) {
